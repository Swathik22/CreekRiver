    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "johndoe@example.com", "John", "Doe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area3-site25.jpg", "Whispering Pines" },
                    { 3, 2, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area5-site85.jpg", "River's Edge" },
                    { 4, 2, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area7-site34.jpg", "Sunset View" },
                    { 5, 3, "https://tnstateparks.com/assets/images/content-images/campgrounds/249/colsp-area6-site83.jpg", "Lakefront Haven" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 1, new DateTime(2024, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });
